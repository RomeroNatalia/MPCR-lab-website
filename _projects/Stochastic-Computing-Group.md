...
building: ''
collaborators: []
description: The Stochastic Computing Group implements a complete ALU using stochastic
  bit streams — where numbers are encoded as probabilities in random sequences. Currently
  a software library, the approach trades precision for radical simplicity in arithmetic
  operations.
email: ''
github: ''
